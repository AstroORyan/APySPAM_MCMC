...
## Main Function
def Secondary_Center(Input_Image,z,block_reduce,Name):
    ...
    plt.imshow(np.log10(Input_Image))
    plt.scatter(y,x)
    plt.title(f'{Name}')
    plt.savefig(f'/mmfs1/home/users/oryan/PySPAM_Original_Python_MCMC_Full/Test_Images/{Name}.png')
    plt.close()
