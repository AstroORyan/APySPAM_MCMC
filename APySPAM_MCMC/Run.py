...
class Run:
  ...
  def main(theta,proj,Resolution,filters,dims,Spectral_Density_1,Spectral_Density_2,z):
      ...
      white_image, white_image_flip_0, white_image_flip_1 = Plotting_Function.plotting(run.x0,Population_Flux,SFRs,len(filters),Resolution,dims,Conversion)

      return white_image, white_image_flip_0, white_image_flip_1, run.params.no_int_flag
